...
class _BodyState extends State<Body> {
  ...
  final ManageRequests _manageRequestsPage = ManageRequests();
  ...
  bottomNavigationBar: CurvedNavigationBar(
    ...
    items: <Widget>[
      ...
      Icon(Icons.post_add,color: kPrimaryColor,),
      Icon(Icons.file_copy_outlined,color: kPrimaryColor,),
      Icon(Icons.more_horiz_outlined,color: kPrimaryColor,),
    ],
